...
def train(env, nb_epochs, nb_epoch_cycles, render_eval, reward_scale, render, param_noise, actor, critic,
    ...
    with U.single_threaded_session() as sess:
        ...
        for epoch in range(nb_epochs):
            ...
            saver.save(tf.get_default_session(), '/home/projectvenom/Documents/AIPilot/AIPilot-ProjectVenom-master/model/Exp1_mv')
            
            if np.mean(roll_success_rate) > max_success_rate:
                max_success_rate = np.mean(roll_success_rate)
                saver.save(tf.get_default_session(), '/home/projectvenom/Documents/AIPilot/AIPilot-ProjectVenom-master/model/Exp1_mv_best')
